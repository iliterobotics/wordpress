...
<div id="homeCarousel" class="carousel carousel-homepage slide" style="margin-top: -20px;">
  ...
  <div id="post-01" class="item active" style="height:310px!important;">
      <img width="1024" height="516" src="/wp-content/uploads/2013/01/Drake-Cheer11.jpg" class="attachment-large wp-post-image" style="width:100%;height:310px!important;" alt="cheers">
...
<?php $posts_query = new WP_Query('posts_per_page=4');
    ...
    ?>
    <span class="headlines-date"><?php the_time('m/j/y') ?></span> <span class="headlines-title"><?php the_title(); ?></span><br/>
